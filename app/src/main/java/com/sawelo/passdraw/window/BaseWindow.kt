...
abstract class BaseWindow(private val context: Context) {
    ...
    private val windowCoroutineScope: CoroutineScope = CoroutineScope(Dispatchers.Main)
    ...
    open fun closeWindow() {
        ...
        beforeCloseWindow()
        if (viewGroup != null) windowManager.removeView(viewGroup)
        viewGroup = null
    }
